...
3.  **Blaster Action**: User defines _how_ to send the code (e.g., calling `remote.send_command` or publishing to `mqtt`). A placeholder `IR_CODE` is used in the data payload.
